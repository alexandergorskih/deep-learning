...
class NeuralNetwork(object):
    ...
    def update_weights(self, delta_weights_i_h, delta_weights_h_o, n_records):
        ...
        '''
        self.weights_hidden_to_output += self.lr * np.sum(delta_weights_h_o) / n_records # update hidden-to-output weights with gradient descent step
        self.weights_input_to_hidden += self.lr * np.sum(delta_weights_i_h) / n_records # update input-to-hidden weights with gradient descent step
